...
LKParticleEffectCamera::LKParticleEffectCamera(const Value &value,LKParticleEffectConfig &config)
{
...
LKParticleEffect2DCamera::LKParticleEffect2DCamera(const Value &value,LKParticleEffectConfig &config):LKParticleEffectCamera(value,config)
{
    
}

LKParticleEffect3DCamera::LKParticleEffect3DCamera(const Value &value,LKParticleEffectConfig &config):LKParticleEffectCamera(value,config)
{
...
LKParticleEffect3DPerspectiveCamera::LKParticleEffect3DPerspectiveCamera(const Value &value,LKParticleEffectConfig &config):LKParticleEffect3DCamera(value,config)
{
    viewMatrix = Matrix4MakeLookAt(0,0,15,0,0,0,0,1,0);
}

LKParticleEffect3DOrthogonalCamera::LKParticleEffect3DOrthogonalCamera(const Value &value,LKParticleEffectConfig &config):LKParticleEffect3DCamera(value,config)
{
